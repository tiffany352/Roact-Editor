...
local devSource = ReplicatedStorage:FindFirstChild("Modules")
...
if useDevSource then
	if devSource ~= nil then
		...
		warn("Development source is not present, running using built-in source.")
	end
end
...
function PluginFacade:_triggerReload()
